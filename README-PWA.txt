我們與珵的大冒險 PWA v5.3.1 · Travel Information Center · Public Browse / Family Modify
...
- JPY ↔ TWD 匯率換算已改為獨立 ?page=exchange 工具頁；首頁與「更多」都可一鍵開啟，並支援每日匯率、離線最後匯率、手動匯率與 1.5%／3% 緩衝
